...
Der Code basiert auf einem Python-Clone von ArcGIS Pro 3.6. Zusätzlich sind folgende Module nötig:
- rasterio
- geographiclib
- skyfield
...
Für diese Plattformen kann direkt das Modul von https://github.com/ChristianSteger/HORAYZON genutzt werden.
